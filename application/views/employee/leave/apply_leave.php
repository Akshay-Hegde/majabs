...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <form class="form-material form-horizontal" id="frmApplyEmpLeave" action="<?php echo base_url('Leave/applyLeave'); ?>" method="POST">
                    <div class="col-md-6">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="leave_type" id="emp-leave-type" class="form-control empLeaves">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 input-group">
                                            <input name="days_left" id="emp-days_left" type="text" class="form-control manipulate-date" placeholder="days balance" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="4" name="description" id="emp-leave-description" disabled></textarea><span class="highlight"></span> <span class="bar"></span>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 input-group">
                                            <input name="date_from" id="emp-leave-from" type="text" class="form-control manipulate-date" onkeydown="return false" placeholder="YYYY-MM-DD" autocomplete="off" /><span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 input-group">
                                            <input name="date_to" id="emp-leave-to" type="text" class="form-control manipulate-date" onkeydown="return false" placeholder="YYYY-MM-DD" autocomplete="off" /><span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="4" name="reason" id="emp-reason"></textarea><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <button name="btnApplyLeave" id="btnApplyEmpLeave" type="submit" class="btn btn-block btn-success btn-lg btn-block">Submit</button>
                                        </div>
...
<script type="text/javascript">
    ...
    jQuery('#emp-leave-to').datepicker({
        format: 'yyyy-mm-dd',
    ...
    jQuery('#emp-leave-from').datepicker({
        format: 'yyyy-mm-dd',
        startDate: moment().format('YYYY-MM-DD'),
        autoclose: true,
        todayHighlight: true
