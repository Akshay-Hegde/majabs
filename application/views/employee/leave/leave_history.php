            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action = "<?php echo base_url('Leave/retrieveLeaveReport'); ?>" method="POST" id="frmRetrieveEmpLeaveReport">
                            ...
                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                <label>From</label>
                                <input class="form-control" name="date_from" id="emp-leave-date-from" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                            </div>

                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                <label>To</label>
                                <input class="form-control" name="date_to" id="emp-leave-date-to" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                            </div>

                            <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                <label>.</label><br/>
                                <button type="submit" id="btnEmpLeaveHistory" class="btn btn-md btn-success">Submit Search </button>
                            </div>
                        </form>
                        <div class="col-md-1 col-sm-6"></div>
                    </div>
