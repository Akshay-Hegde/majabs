        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Employee Logs</h4>
                </div>
            ...
            <div class="p-20 row">
                <div class="col-lg-4 col-md-4 col-md-offset-5">
                    <a  href="javascript:void" data-toggle="tooltip" title="Click To Clock Out" class="btn btn-danger btn-rounded clock-out">
                        <span class="circle circle-sm bg-success di"><i class="ti-time"></i></span><span>  <b>KNOCK OFF TIME ?</b></span>
                    </a>
                </div>
            </div>
                                    ...
                                    <?php
                                        ...
                                        if($empLogs !== null) {
                                            ...
                                            foreach ($empLogs as $empLog) {
                                                ...
                                                echo '                                    
                                                    <tr id="log_'.$empLog->log_id.'">
                                                        <td>'.++$counter.'</td>
                                                        <td>
                                                            <a href="javascript:void;">'.$empLog->day.'</a>
                                                        </td>
                                                        <td>'.$empLog->date.'</td>
                                                        <td>'.$empLog->time_in.'</td>
                                                        <td>'.$empLog->time_out.' </td>
                                                    </tr>';
                                            }
                                        }
