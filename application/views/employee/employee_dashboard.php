...
<div id="wrapper">
    ...
    <?php include APP_VIEWS."employee/navigation/top-nav.php"; ?>
    <!-- End Top Navigation -->
    <!-- ============================================================== -->
    ...
    <!--SIDE NAV HERE-->
    <?php include APP_VIEWS."employee/navigation/side-nav.php"; ?>
    <!-- ============================================================== -->
    <!-- End Left Sidebar -->
    <!-- ============================================================== -->
    <!-- ============================================================== -->
                        ...
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15"><?php echo $empStats['totalDays']; ?></h3></li>
                                    <li class="col-middle">
                                        <h4>Days At Work</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12  b-0">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15"><?php echo $empStats['totalTasks']; ?></h3></li>
                                    <li class="col-middle">
                                        <h4>Total Tasks</h4>
                                        <div class="progress">
