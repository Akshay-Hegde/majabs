        ...
        <div class="container-fluid">
            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-1 col-sm-6"></div>
                    <form action = "<?php echo base_url('Task/retrieveEmpTaskReport'); ?>" method="POST" id="frmEmpTaskReport">
                        ...
                        <div class="form-group col-lg-2 col-md-3 col-sm-6">
                            <label>From</label>
                            <input class="form-control" name="date_from" id="emp-date-from" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                        </div>

                        <div class="form-group col-lg-2 col-md-3 col-sm-6">
                            <label>To</label>
                            <input class="form-control" name="date_to" id="emp-date-to" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                        </div>

                        <div class="form-group col-lg-2 col-md-2 col-sm-6">
                            <label>.</label><br/>
                            <button type="submit" id="btnEmpTaskReport" class="btn btn-md btn-success">Submit Search </button>
                        </div>
                    </form>
                    <div class="col-md-1 col-sm-6"></div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title">Employee Task Report</h3>
...
<script type="text/javascript">
    ...
    jQuery('#emp-date-from').datepicker({
        format: 'yyyy-mm-dd',
        autoclose: true,
