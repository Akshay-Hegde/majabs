...
<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <!--<img src="../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle">--><b class="hidden-xs"><?php echo $employee['name'].' '.$employee['surname'];?>(Manager)</b><span class="caret"></span> </a>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                            ...
                            <li><a href="<?php echo base_url('manager-notifications'); ?>"><i class="ti-book"></i> Inbox</a></li>
                            <li role="separator" class="divider"></li>
