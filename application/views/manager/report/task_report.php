            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-1 col-sm-6"></div>
                        <form action = "<?php echo base_url('Task/retrieveManagerTaskReport'); ?>" method="POST" id="frmManagerTaskReport">
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                <label>.</label><br/>
                                <button type="submit" id="btnManagerTaskReport" class="btn btn-md btn-success">Submit Search </button>
                            </div>
                        </form>
                        <div class="col-md-1 col-sm-6"></div>
                    </div>
                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table product-overview" id="myTable">
                            ...
                            <tbody id="tbl-manager-task-report">
