            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-1 col-sm-6"></div>
                        <form action = "<?php echo base_url('Employee/getManagerEmpReport'); ?>" method="POST" id="frmManagerEmployeeReport">
                            ...
                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                ...
                                <select name="searchLeaveKey" class="form-control select2 m-b-10 select2-multiple" data-placeholder="Pick Search Key">
                                    <option selected value="1000">All</option>
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                <label>.</label><br/>
                                <button type="submit" id="btnManagerEmpReport" class="btn btn-md btn-success">Submit Search </button>
                            </div>
                        </form>
                        <div class="col-md-1 col-sm-6"></div>
                    </div>
                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table product-overview" id="myTable">
                            ...
                            <tbody id="tbl-manager-emp-report">
