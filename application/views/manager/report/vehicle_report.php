            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-1 col-sm-6"></div>
                        <form action = "<?php echo base_url('Vehicle/retrieveManagerVehicleReport'); ?>" method="POST" id="frmManagerVehicleReport">

                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                <label>Search By </label>

                                <select name="searchKey" class="form-control select2 m-b-10 select2-multiple" data-placeholder="Pick Search Key">
                                    <option selected value="all">All</option>
                                    <option value="disc">Disc Expiry Date</option>
                                    <option value="serv">Next Service Date</option>
                                </select>
                            ...
                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                <label>From</label>
                                <input class="form-control" name="date_from" id="date-from" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                            </div>

                            <div class="form-group col-lg-2 col-md-3 col-sm-6">
                                <label>To</label>
                                <input class="form-control" name="date_to" id="date-to" type="text" placeholder="YYYY-MM-DD" onkeydown="return false" autocomplete="off"/>
                            </div>

                            <div class="form-group col-lg-2 col-md-2 col-sm-6">
                                <label>.</label><br/>
                                <button type="submit" id="btnManagerVehicleReport" class="btn btn-md btn-success">Submit Search </button>
                            </div>
                        </form>
                        <div class="col-md-1 col-sm-6"></div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                ...
                                <tr>
                                    <th>No</th>
                                    <th>Registration</th>
                                    <th>Disc Expiry Date</th>
                                    <th>Next Service Date</th>
                                </tr>
                                </thead>
                                <tbody id="tbl-manager-vehicle-report">
