        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"> Service Manager</h4>
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                    ...
                                    <tr>
                                        <th>No</th>
                                        <th>Type</th>
                                        <th>Vehicles Been To Service</th>
                                        <th>Actions</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    if($services !== null) {
                                        ...
                                        foreach ($services as $service) {
                                            echo '                            
                                        <tr id="manager_leave_list_' . $service->service_id . '">
                                            <td>' . ++$counter. '</td>
                                            <td>' . $service->service_type . '</td>
                                            <td>' . $service->numberOfVehicles . '</td>
                                                                                 
                                            <td>
                                                <a href="'. base_url('vehicles-onservice/'.$service->service_id) .'" data-toggle="tooltip" class="btn btn-warning" title="View employees on leave">ViewEmployees</a>
                                            </td>
