        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"> Employee Leave Manager</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li class=""><a href="<?php echo base_url('dashboard'); ?>">Dashboard</a></li>
                        <li class="active"> Approve or Reject Leave </li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                                ...
                                <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                    ...
                                    if($LeaveRequests !== null) {
                                        ...
                                        foreach ($LeaveRequests as $LeaveRequest) {
                                            ...
                                            echo '                                    
                                                    <tr id="apply_'.$LeaveRequest->emp_leave_id.'">
                                                        <td>'.++$counter.'</td>
                                                        <td>
                                                            <a href="javascript:void;">'.$LeaveRequest->name.'</a>
                                                        </td>
                                                        <td>'.$LeaveRequest->type.'</td>
                                                        <td>'.$LeaveRequest->from_date.'</td>
                                                        <td>'.$LeaveRequest->to_date.' </td>
                                                        <td>
                                                            <input type="hidden" id="approve-emp-id_'.$LeaveRequest->emp_leave_id.'" value="'.$LeaveRequest->employee_id.'">
                                                            <input type="hidden" id="leave-handler-id_'.$LeaveRequest->emp_leave_id.'" value="'.$LeaveRequest->leave_handler_id.'">
                                                            <input type="hidden" id="approve-leave-id_'.$LeaveRequest->emp_leave_id.'" value="'.$LeaveRequest->leave_id.'">
                                                            <button class="btn btn-success approve-leave">Approve</button>
