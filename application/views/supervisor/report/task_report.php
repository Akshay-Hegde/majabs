        ...
        <div class="container-fluid">
            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-1 col-sm-6"></div>
                    <form action = "<?php echo base_url('Task/retrieveSuperTaskReport'); ?>" method="POST" id="frmSupervisorTaskReport">
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-6">
                            <label>.</label><br/>
                            <button type="submit" id="btnSuperVisorTaskReport" class="btn btn-md btn-success">Submit Search </button>
                        </div>
                    </form>
                    <div class="col-md-1 col-sm-6"></div>
                    </div>
