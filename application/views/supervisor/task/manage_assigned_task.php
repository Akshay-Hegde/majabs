        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title">List Of Tasks that are on progress</h3>
                            ...
                            if($assignedTasks !== null) {
                                ...
                                foreach ($assignedTasks as $assignedTask){
                                    echo
                                        ...
                                        '<tr id="row_task_completed_' . $assignedTask->task_id . '">
                                            <td>' . $assignedTask->title . '</td>
                                            <td>' . $assignedTask->description . '</td>
                                            <td>' . $assignedTask->employee . '</td>
                                        
                                            <td>
                                                <a class="btn btn-warning task-complete" href="javascript:void(0)" title="Complete Task" data-toggle="tooltip" role="button">Completed ?</a>
                                            </td>
