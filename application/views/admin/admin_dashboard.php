...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <?php include APP_VIEWS."navigations/top-nav.php"; ?>
        <!-- End Top Navigation -->
        <!-- ============================================================== -->
        ...
        <!--SIDE NAV HERE-->
        <?php include APP_VIEWS."navigations/side-nav.php"; ?>
        <!-- ============================================================== -->
        <!-- End Left Sidebar -->
        <!-- ============================================================== -->
        <!-- ============================================================== -->
                            ...
                            <div class="row row-in">
                                <div class="col-lg-4 col-sm-12 row-in-br">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15"><?php echo $adminStats['total_vehicles'];?></h3></li>
                                        <li class="col-middle">
                                ...
                                <div class="col-lg-4 col-sm-12 row-in-br  b-r-none">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15"><?php echo $adminStats['total_tasks'];?></h3></li>
                                        <li class="col-middle">
                                            <h4>Total Tasks</h4>
                                            <div class="progress">
                                ...
                                <div class="col-lg-4 col-sm-12  b-0">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15"><?php echo $adminStats['total_employees'];?></h3></li>
                                        <li class="col-middle">
