...
<head>
    ...
    <title> <?php echo APP_NAME.'-Manage Tasks'; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Taks Management</h4>
                </div>
            ...
            <div id="add-task" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form id="frmRegisterTask" action="<?php echo base_url('Task/registerTask');?>" method="POST">
                    <div class="modal-content">
                            ...
                            <from class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 m-b-20">
                                        <input type="text" name="title" id="title" class="form-control" placeholder="Task Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12 m-b-20">
                                        <textarea name="description" id="description" class="form-control" rows="4" placeholder="Task Description" required></textarea><span class="highlight"></span> <span class="bar"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12 m-b-20">
                                        <select name="attributes[]" id="attributes" class="select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Choose Attribute">
                                            <?php
                                                if($attributes !== null) {
                        ...
                        <div class="modal-footer">
                            <button type="submit" id="btnRegisterTask" class="btn btn-info waves-effect" >Save</button>
                ...
                <div class="col-md-12">
                    ...
                    <div class="p-20 row">
                        <div class="col-lg-4 col-md-4 col-md-offset-4">
                            <a href="javascript:void" data-toggle="modal" data-target="#add-task" class="btn btn-outline btn-default btn-lg btn-block">
                                <span class="circle circle-sm bg-success di"><i class="ti-plus"></i></span><span>  Add Task</span>
                            </a>
                        </div>
                    </div>
                                    ...
                                    foreach ($tasks as $task) {
                                        echo '                                
                                            <tr id="row_task_' . $task->task_id . '">
                                               ...
                                               <td>
                                                    <a href="' . base_url('edit-task/' . $task->task_id) . '" class="btn btn-warning edit-task" role="button">Edit</a>
