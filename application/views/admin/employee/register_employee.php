...
<head>
    ...
    <title> <?php echo APP_NAME.' Register Employee'; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li class=""><a href="manage_employee.php">Manage Employee</a></li>
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2"">
                    <div class="white-box p-l-20 p-r-20">
                        <h3 class="box-title m-b-0">register account</h3>
                        <p class="text-muted m-b-30 font-13"> </p>
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-material form-horizontal" id="frmAddEmployee" action="<?php echo base_url('Employee/registerEmployee'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-md-12"> First Name <span class="help"></span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="name" name="name" class="form-control form-control-line" placeholder="First Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"> Last Name <span class="help"></span></label>
                                        <div class="col-md-12">
                                            <input type="text" id="surname" name="surname" class="form-control form-control-line" placeholder="Last Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="id-number" name="id_number" class="form-control" placeholder="ID Number">
                                        </div>
                                    </div>
                                                ...
                                                <?php
                                                    if($roles !== null) {
                                                        ...
                                                        foreach ($roles as $role) {
                                                            ...
                                                            echo '<option value="'.$role->role_id.'">'.$role->type.'</option>';
                                                        }
                                                    }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="attributes[]" id="attributes" class="form-control select2 m-b-10 select2-multiple" multiple="multiple" data-placeholder="Choose Type">
                                                <?php
                                                if($attributes !== null) {

                                                    foreach ($attributes as $attribute) {

                                                        echo '<option value="'.$attribute->attribute_id.'">'.$attribute->description.'</option>';
                                                    }
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                <div class="form-control" data-trigger="fileinput"> <i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename"></span></div> <span class="input-group-addon btn btn-default btn-file"> <span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
                                                    <input type="file" name="contractFile" id="contractFile"> </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 input-group">
                                            <input name="contract_expiry_date"  type="text" onkeydown="return false" placeholder="Contract expiry date" autocomplete="off" id="contract_expiry_date" class="form-control manipulate-date" /><span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 input-group">
                                            <input name="license_expiry_date"  type="text" onkeydown="return false" placeholder="License expiry date" autocomplete="off" id="license-expiry" class="form-control manipulate-date" /><span class="input-group-addon"> <span class="glyphicon glyphicon-calendar"></span> </span>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <button name="btnRegisterEmp" id="btnRegisterEmp" type="submit" class="btn btn-block btn-success btn-lg btn-block">Submit</button>
                                        </div>
                                    </div>
...
<script>
    ...
    jQuery('#contract_expiry_date').datepicker({
        format: 'yyyy-mm-dd',
    ...
    jQuery('#license-expiry').datepicker({
        format: 'yyyy-mm-dd',
        startDate: moment().format('YYYY-MM-DD'),
        autoclose: true,
        todayHighlight: true
